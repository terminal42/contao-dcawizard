!function () {
    ...
    class e {
        constructor (e, t, r) {
            this.eventTarget = e, this.eventName = t, this.eventOptions = r, this.unorderedBindings = new Set
        }
    ...
    class t {
        ...
        removeMappedEventListenerFor (e) {
            const { eventTarget: t, eventName: r, eventOptions: s } = e,
                n = this.fetchEventListenerMapForEventTarget(t), i = this.cacheKey(r, s);
        ...
        fetchEventListener (e, t, r) {
            const s = this.fetchEventListenerMapForEventTarget(e), n = this.cacheKey(t, r);
            let i = s.get(n);
            return i || (i = this.createEventListener(e, t, r), s.set(n, i)), i
        }

        createEventListener (t, r, s) {
            const n = new e(t, r, s);
    ...
    class d {
        constructor (e, t, r, s) {
            this.element = e, this.index = t, this.eventTarget = r.eventTarget || e, this.eventName = r.eventName || function (e) {
                const t = e.tagName.toLowerCase();
                if (t in m) return m[t](e)
            }(e) || g("missing event name"), this.eventOptions = r.eventOptions || {}, this.identifier = r.identifier || g("missing identifier"), this.methodName = r.methodName || g("missing method name"), this.keyFilter = r.keyFilter || "", this.schema = s
        }

        static forToken (e, t) {
            return new this(e.element, e.index, function (e) {
                const t = e.trim().match(s) || [];
                let r = t[2], i = t[3];
        ...
        shouldIgnoreKeyboardEvent (e) {
            ...
            const r = t.filter(e => !u.includes(e))[0];
            return !!r && (h(this.keyMappings, r) || g(`contains unknown key filter: ${ this.keyFilter }`), this.keyMappings[r].toLowerCase() !== e.key.toLowerCase())
        }
        ...
        keyFilterDissatisfied (e, t) {
            const [r, s, n, i] = u.map(e => t.includes(e));
    ...
    class f {
        ...
        applyEventModifiers (e) {
            const { element: t } = this.action, { actionDescriptorFilters: r } = this.context.application, { controller: s } = this.context;
            let n = !0;
            for (const [i, o] of Object.entries(this.eventOptions)) if (i in r) {
                const a = r[i];
    ...
    class b {
        constructor (e, t, r) {
            this.attributeName = t, this.delegate = r, this.elementObserver = new v(e, this)
        }
    ...
    class w {
        constructor (e, t, r, s) {
            this._selector = t, this.details = s, this.elementObserver = new v(e, this), this.delegate = r, this.matchesByElement = new A
        }
        ...
        elementAttributeChanged (e, t) {
            ...
            if (r) {
                const t = this.matchElement(e), s = this.matchesByElement.has(r, e);
    ...
    class k {
        constructor (e, t, r) {
            this.attributeObserver = new b(e, t, this), this.delegate = r, this.tokensByElement = new A
        }
        ...
        refreshTokensForElement (e) {
            const t = this.tokensByElement.getValuesForKey(e), r = this.readTokensForElement(e), s = function (e, t) {
        ...
        readTokensForElement (e) {
            ...
            return function (e, t, r) {
                return e.trim().split(/\s+/).filter(e => e.length).map((e, s) => ({
                    element: t,
                    attributeName: r,
                    content: e,
                    index: s
    ...
    class N {
        constructor (e, t, r) {
            this.tokenListObserver = new k(e, t, this), this.delegate = r, this.parseResultsByToken = new WeakMap, this.valuesByTokenByElement = new WeakMap
        }
    ...
    class F {
        ...
        start () {
            this.valueListObserver || (this.valueListObserver = new N(this.element, this.actionAttribute, this), this.valueListObserver.start())
        }
    ...
    class C {
        constructor (e, t) {
            this.context = e, this.receiver = t, this.stringMapObserver = new M(this.element, this), this.valueDescriptorMap = this.controller.valueDescriptorMap
        }
        ...
        stringMapValueChanged (e, t, r) {
            ...
            null !== e && (null === r && (r = s.writer(s.defaultValue)), this.invokeChangedCallback(t, e, r))
        }
        ...
        invokeChangedCallbacksForDefaultValues () {
            for (const {
                ...
                defaultValue: r,
                writer: s
            } of this.valueDescriptors) null == r || this.controller.data.has(e) || this.invokeChangedCallback(t, s(r), void 0)
        }
        ...
        invokeChangedCallback (e, t, r) {
            ...
            if ("function" == typeof n) {
                ...
                try {
                    ...
                    throw e instanceof TypeError && (e.message = `Stimulus Value "${ this.context.identifier }.${ s.name }" - ${ e.message }`), e
                }
            }
        }
    ...
    class B {
        constructor (e, t) {
            this.context = e, this.delegate = t, this.targetsByName = new A
        }
        ...
        connectTarget (e, t) {
            var r;
            this.targetsByName.has(t, e) || (this.targetsByName.add(t, e), null === (r = this.tokenListObserver) || void 0 === r || r.pause(() => this.delegate.targetConnected(e, t)))
        }

        disconnectTarget (e, t) {
            var r;
            this.targetsByName.has(t, e) && (this.targetsByName.delete(t, e), null === (r = this.tokenListObserver) || void 0 === r || r.pause(() => this.delegate.targetDisconnected(e, t)))
        }
    ...
    function T (e, t) {
        const r = x(e);
        return Array.from(r.reduce((e, r) => (function (e, t) {
            const r = e[t];
            return Array.isArray(r) ? r : []
        }(r, t).forEach(t => e.add(t)), e), new Set))
    }

    function S (e, t) {
        return x(e).reduce((e, r) => (e.push(...function (e, t) {
            const r = e[t];
    ...
    class D {
        constructor (e, t) {
            this.started = !1, this.context = e, this.delegate = t, this.outletsByName = new A, this.outletElementsByName = new A, this.selectorObserverMap = new Map, this.attributeObserverMap = new Map
        }
        ...
        selectorMatchElement (e, { outletName: t }) {
            const r = this.selector(t), s = this.hasOutlet(e, t),
        ...
        connectOutlet (e, t, r) {
            var s;
            this.outletElementsByName.has(r, t) || (this.outletsByName.add(r, e), this.outletElementsByName.add(r, t), null === (s = this.selectorObserverMap.get(r)) || void 0 === s || s.pause(() => this.delegate.outletConnected(e, t, r)))
        }

        disconnectOutlet (e, t, r) {
            var s;
            this.outletElementsByName.has(r, t) && (this.outletsByName.delete(r, e), this.outletElementsByName.delete(r, t), null === (s = this.selectorObserverMap.get(r)) || void 0 === s || s.pause(() => this.delegate.outletDisconnected(e, t, r)))
        }

        disconnectAllOutlets () {
            for (const e of this.outletElementsByName.keys) for (const t of this.outletElementsByName.getValuesForKey(e)) for (const r of this.outletsByName.getValuesForKey(e)) this.disconnectOutlet(r, t, e)
        }
        ...
        setupSelectorObserverForOutlet (e) {
            const t = this.selector(e), r = new w(document.body, t, this, { outletName: e });
            this.selectorObserverMap.set(e, r), r.start()
        }

        setupAttributeObserverForOutlet (e) {
            const t = this.attributeNameForOutletName(e), r = new b(this.scope.element, t, this);
        ...
        get outletDependencies () {
            ...
            return this.router.modules.forEach(t => {
                T(t.definition.controllerConstructor, "outlets").forEach(r => e.add(r, t.identifier))
            }), e
        }
    ...
    class L {
        constructor (e, t) {
            ...
            }, this.module = e, this.scope = t, this.controller = new e.controllerConstructor(this), this.bindingObserver = new F(this, this.dispatcher), this.valueObserver = new C(this, this.controller), this.targetObserver = new B(this, this), this.outletObserver = new D(this, this);
            try {
        ...
        handleError (e, t, r = {}) {
            ...
            r = Object.assign({
                ...
                controller: n,
                element: i
            }, r), this.application.handleError(e, `Error ${ t }`, r)
        }
        ...
        outletConnected (e, t, r) {
            this.invokeControllerMethod(`${ o(r) }OutletConnected`, e, t)
        }

        outletDisconnected (e, t, r) {
            this.invokeControllerMethod(`${ o(r) }OutletDisconnected`, e, t)
        }
    ...
    function K (e) {
        return function (e, t) {
            const r = I(e), s = function (e, t) {
                return j(t).reduce((r, s) => {
                    const n = function (e, t, r) {
                        const s = Object.getOwnPropertyDescriptor(e, r);
                        if (!s || !("value" in s)) {
                            const e = Object.getOwnPropertyDescriptor(t, r).value;
                            return s && (e.get = s.get || e.get, e.set = s.set || e.set), e
                        }
                    }(e, t, s);
    ...
    const j = "function" == typeof Object.getOwnPropertySymbols ? e => [...Object.getOwnPropertyNames(e), ...Object.getOwnPropertySymbols(e)] : Object.getOwnPropertyNames,
        I = (() => {
            function e (e) {
                function t () {
    ...
    class P {
        ...
        warn (e, t, r) {
            ...
            s || (s = new Set, this.warnedKeysByObject.set(e, s)), s.has(t) || (s.add(t), this.logger.warn(r, e))
        }
    }
    ...
    class q {
        ...
        deprecate (e, t) {
            if (e) {
                const { identifier: r } = this, s = this.schema.targetAttribute,
                    n = this.schema.targetAttributeForScope(r);
                this.guide.warn(e, `target:${ t }`, `Please replace ${ s }="${ r }.${ t }" with ${ n }="${ t }". The ${ s } attribute is deprecated and will be removed in a future version of Stimulus.`)
            }
            return e
        }
    ...
    class W {
        constructor (e, t, r, s) {
            this.targets = new q(this), this.classes = new R(this), this.data = new U(this), this.containsElement = e => e.closest(this.controllerSelector) === this.element, this.schema = e, this.element = t, this.identifier = r, this.guide = new P(s), this.outlets = new _(this.documentScope, t)
        }
    ...
    class J {
        constructor (e, t, r) {
            this.element = e, this.schema = t, this.delegate = r, this.valueListObserver = new N(this.element, this.controllerAttribute, this), this.scopesByIdentifierByElement = new WeakMap, this.scopeReferenceCounts = new WeakMap
        }
    ...
    class H {
        constructor (e) {
            this.application = e, this.scopeObserver = new J(this.element, this.schema, this), this.scopesByIdentifier = new A, this.modulesByIdentifier = new Map
        }
        ...
        loadDefinition (e) {
            ...
            const t = new V(this.application, e);
    ...
    function X (e, t, r) {
        let s = G(e, t, r);
        return s || (e.application.router.proposeToConnectScopeForElementAndIdentifier(t, r), s = G(e, t, r), s || void 0)
    }

    function Y ([e, t], r) {
        return function (e) {
            const { token: t, typeDefinition: r } = e, s = `${ c(t) }-value`, n = function (e) {
                const { controller: t, token: r, typeDefinition: s } = e,
                    n = { controller: t, token: r, typeObject: s }, i = function (e) {
                        const { controller: t, token: r, typeObject: s } = e, n = l(s.type), i = l(s.default), o = n && i,
                            a = n && !i, c = !n && i, h = ee(s.type), u = te(e.typeObject.default);
                        if (a) return h;
                        if (c) return u;
                        if (h !== u) {
                            throw new Error(`The specified default value for the Stimulus Value "${ t ? `${ t }.${ r }` : r }" must match the defined type "${ h }". The provided default value of "${ s.default }" is of type "${ u }".`)
                        }
                        if (o) return h
                    }(n), o = te(s), a = ee(s), c = i || o || a;
                if (c) return c;
                const h = t ? `${ t }.${ s }` : r;
                throw new Error(`Unknown value type "${ h }" for "${ r }" value`)
            }(e);
            return {
                type: n, key: s, name: i(s), get defaultValue () {
                    return function (e) {
                        const t = ee(e);
                        if (t) return re[t];
                        const r = h(e, "default"), s = h(e, "type"), n = e;
                        if (r) return n.default;
                        if (s) {
                            const { type: e } = n, t = ee(e);
                            if (t) return re[t]
                        }
                        return e
                    }(r)
                    ...
                    return void 0 !== te(r)
                }, reader: se[n], writer: ne[n] || ne.default
            }
    ...
    const re = {
        ...
        array (e) {
            ...
            if (!Array.isArray(t)) throw new TypeError(`expected value of type "array" but instead got value "${ e }" of type "${ te(t) }"`);
            return t
        }, boolean (e) {
            ...
            const t = JSON.parse(e);
            if (null === t || "object" != typeof t || Array.isArray(t)) throw new TypeError(`expected value of type "object" but instead got value "${ e }" of type "${ te(t) }"`);
            return t
        }, string (e) {
            return e
        }
    ...
    oe.blessings = [function (e) {
        ...
        const t = S(e, "values"), r = {
            valueDescriptorMap: {
                get () {
                    return t.reduce((e, t) => {
                        const r = Y(t, this.identifier), s = this.data.getAttributeNameForKey(r.key);
        ...
        return t.reduce((e, t) => Object.assign(e, function (e, t) {
            const r = Y(e, t), { key: s, name: n, reader: i, writer: o } = r;
            return {
                [n]: {
                    get () {
        ...
        return T(e, "outlets").reduce((e, t) => Object.assign(e, function (e) {
            ...
            return {
                [`${ t }Outlet`]: {
                    get () {
                        const t = this.outlets.find(e), r = this.outlets.getSelectorForOutletName(e);
                        if (t) {
                            const r = X(this, t, e);
                            if (r) return r;
    ...
    }], oe.targets = [], oe.outlets = [], oe.values = {};
    const he = class {
        constructor (e = document.documentElement, s = Q) {
            this.logger = console, this.debug = !1, this.logDebugActivity = (e, t, r = {}) => {
                this.debug && this.logFormattedMessage(e, t, r)
            }, this.element = e, this.schema = s, this.dispatcher = new t(this), this.router = new H(this), this.actionDescriptorFilters = Object.assign({}, r)
        }
    ...
    function ue (e) {
        try {
            return JSON.parse(e.currentTarget.dataset.dcawizardOptions)
        } catch {
            return console.error(`Could not parse JSON options for DCA wizard: ${ e.currentTarget.dataset.dcawizardOptions }`), null
        }
    }

    function de (e) {
        new Request.Contao({
            evalScripts: !1, onSuccess: (t, r) => {
                $(`ctrl_${ e.id }`).set("html", r.content), r.javascript && Browser.exec(r.javascript), AjaxRequest.hideBox(), window.fireEvent("ajax_change")
            }
        }).post({ action: "reloadDcaWizard", name: e.id, REQUEST_TOKEN: Contao.request_token, class: e.class })
    }

    he.debug = !1, he.register("terminal42--dcawizard", (ae = new WeakSet, class extends oe {
        constructor (...e) {
            super(...e), ce(this, ae)
        }

        delete (e) {
            const t = le(ae, this, ue).call(this, e);
            null !== t && window.confirm(t.confirm) && new Request.Contao({
                method: "get",
                url: t.url,
                evalScripts: !1,
                followRedirects: !1,
                onRequest: AjaxRequest.displayBox(`${ Contao.lang.loading } …`),
                onComplete: () => le(ae, this, de).call(this, t)
            }).send()
        }
        ...
        open (e) {
            const t = le(ae, this, ue).call(this, e);
            if (null === t) return;
            const r = (window.getSize().x - 20).toInt(), s = (window.getSize().y - 137).toInt();
            (!t.width || t.width > r) && (t.width = Math.min(r, 900)), (!t.height || t.height > s) && (t.height = s);
            new SimpleModal({
                width: t.width,
                hideFooter: !0,
                draggable: !1,
                ...
                onHide: () => {
                    document.body.setStyle("overflow", "auto"), AjaxRequest.displayBox(`${ Contao.lang.loading } …`), le(ae, this, de).call(this, t)
                }
            }).show({
...
//# sourceMappingURL=dcawizard.54889874.js.map
