...
class DcaWizard extends Widget
{
    ...
    public function generate(): string
    {
        ...
        $objTemplate->dcaLabel = fn (string $field) => System::getContainer()->get(Formatter::class)->dcaLabel($this->foreignTable, $field);
        $objTemplate->dcaValue = fn (string $field, mixed $value) => System::getContainer()->get(Formatter::class)->dcaValue($this->foreignTable, $field, $value, $this->dataContainer);
